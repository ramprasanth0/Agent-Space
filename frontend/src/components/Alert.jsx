...
const Alert = forwardRef(function Alert(
  { visibleDuration = 4000, fadeDuration = 500 } = {},
  ref
) {
  ...
  useImperativeHandle(
    ...
    () => ({
      show(msg) {
        ...
        fadeTimeout.current = setTimeout(() => setVisible(false), visibleDuration); // configurable hold duration
        unmountTimeout.current = setTimeout(
          () => setMessage(""),
          visibleDuration + fadeDuration // configurable fade + unmount duration
        );
      },
    }),
